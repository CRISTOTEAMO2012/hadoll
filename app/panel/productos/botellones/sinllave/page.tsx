...
export default function SinLlave(){
...
let datos = JSON.parse(localStorage.getItem("botellonesSinLlave") || "{}")
...
localStorage.setItem("botellonesSinLlave",JSON.stringify(datos))
