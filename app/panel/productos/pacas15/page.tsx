...
export default function Pacas15(){
...
let datos = JSON.parse(localStorage.getItem("pacas15")||"{}")
...
localStorage.setItem("pacas15",JSON.stringify(datos))
