...
export default function Vehiculo3(){
...
if(data[2]){
setMarca(data[2].marca)
setPlaca(data[2].placa)
setChofer(data[2].chofer)
}
...
<Link href="/panel/vehiculos/vehiculo3/cargar">
<button style={botonAzul}>📦 Cargar Vehículo</button>
</Link>

<Link href="/panel/vehiculos/vehiculo3/inventario">
<button style={botonVerde}>📊 Inventario Vehículo</button>
</Link>

<Link href="/panel/vehiculos/vehiculo3/devolucion">
